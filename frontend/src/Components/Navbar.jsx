      ...
      <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img className="h-10 rounded-full w-auto" src="./jf.png" alt="" />
          </a>
        </div>
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          ...
          <Link to="/about" className="text-sm/6 font-semibold text-gray-900"><b>About Job.find</b>   </Link>
         
         
        </div>
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link to='/login' onClick={handleLogout} className="text-sm/6 font-semibold text-gray-900">Log out <span aria-hidden="true">&rarr;</span></Link> 
        </div>
      </nav>
      ...
      <div className="lg:hidden" role="dialog" aria-modal="true">
        ...
        <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Your Company</span>
              <img className="h-8 w-auto" src="./jf.png" alt="" />
            </a>
